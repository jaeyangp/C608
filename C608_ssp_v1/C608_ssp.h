// C608 Fingerprint Image Sensor
// Evaluation
// Hardware platform: ARM mbed LPC1768
//
// CMOS Sensor Inc.
//
...
#define DPI1016_ROWS 		240	//60				// 240
...
uint16_t current_cfg = 0xE110;		// Gnd = 3, Slope = 2, 4pd, 508 dpi, led_on = 16
